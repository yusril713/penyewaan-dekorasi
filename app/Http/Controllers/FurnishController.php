...
class FurnishController extends Controller
{
    ...
    {
        return view('admin.furnish.index', [
            'products' => Product::where(
                'category', '=', Product::FURNISH
            )->get()
        ]);
    }
    ...
    {
        return view('admin.furnish.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('furnish.manage.index');
    }

    public function edit($id)
    {
        return view('admin.furnish.edit', [
    ...
    public function storeImage(Request $request, $id)
    {
        ...
        return redirect()->route('furnish.manage.detail.index', [$id]);
    }
